...
export function AIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hey there! 👋 I'm your Leechy assistant. I can help you find rentals, answer questions about listings, or assist with your account. What can I do for you today?",
      isUser: false,
      timestamp: new Date()
    }
  ])
    ...
    return (
      <div className="fixed top-4 right-4 z-50">
        <Button
          ...
          className="bg-gradient-to-r from-cyan-700/80 to-green-600/80 backdrop-blur-md rounded-full shadow-lg border border-white/20 text-white hover:from-cyan-700/90 hover:to-green-600/90 transition-all duration-200 p-3"
        >
